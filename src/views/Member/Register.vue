    ...
    <div class="container">
      ...
      <Form v-slot="{ errors }" action="" class="m-auto mb-20 sm:w-4/5 lg:w-3/5">
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row relative">
          <label
            class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]"
            for="phone"
            ><span class="text-Wred">*</span>手機號碼</label
          >
          <Field
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row relative">
          <label
            class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]"
            for="phoneQ"
            ><span class="text-Wred">*</span>驗證碼</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-120px)]"
            id="phoneCode"
            ...
            type="text"
            label="驗證碼"
            :class="{ 'is-invalid': errors['phoneCode'] }"
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row relative">
          <label
            class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]"
            for="email"
            ><span class="text-Wred">*</span>電子信箱</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-120px)]"
            id="email"
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row relative">
          <label
            class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]"
            for="pw"
            ><span class="text-Wred">*</span>密碼</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-120px)]"
            id="password1"
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row relative">
          <label
            class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]"
            for="pw2"
            ><span class="text-Wred">*</span>確認密碼</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-120px)]"
            id="password2"
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row">
          <label
            class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]"
            for="name"
            ><span class="text-Wred">*</span>姓名</label
          >
          <input
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-120px)]"
            id="name"
        ...
        <div class="flex flex-col gap-5 mb-7 xs:flex-row">
          <label class="w-full text-lg font-bold p-1 xs:border-r xs:border-gray xs:w-[100px]" for=""
            >聯絡地址</label
          >
