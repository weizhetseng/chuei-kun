    ...
    <div class="w-full lg:w-4/5">
      ...
      >
        <div class="flex flex-col gap-5 mb-7 relative xs:flex-row">
          <label
            class="w-full text-lg xs:text-right p-1 xs:border-r xs:border-gray xs:w-[120px]"
            for="opw"
            ><span class="text-Wred">*</span>舊密碼</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-140px)]"
            id="oldPW"
            name="oldPW"
            type="text"
            label="舊密碼"
            :class="{ 'is-invalid': errors['oldPW'] }"
            placeholder="請輸入舊密碼"
            rules="required"
          >
          </Field>
        ...
        <div class="flex flex-col gap-5 mb-7 relative xs:flex-row">
          <label
            class="w-full text-lg xs:text-right p-1 xs:border-r xs:border-gray xs:w-[120px]"
            for="npw"
            ><span class="text-Wred">*</span>新密碼</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-140px)]"
            id="newPW1"
            ...
            type="password"
            label="新密碼"
            :class="{ 'is-invalid': errors['newPW1'] }"
            placeholder="請輸入新密碼"
            rules="required"
          >
          </Field>
        ...
        <div class="flex flex-col gap-5 mb-7 relative xs:flex-row">
          <label
            class="w-full text-lg xs:text-right p-1 xs:border-r xs:border-gray xs:w-[120px]"
            for="npw2"
            ><span class="text-Wred">*</span>確認新密碼</label
          >
          <Field
            class="w-full outline-none border-b border-lgray xs:w-[calc(100%-140px)]"
            id="newPW2"
            ...
            type="password"
            label="確認新密碼"
            :class="{ 'is-invalid': errors['newPW2'] }"
