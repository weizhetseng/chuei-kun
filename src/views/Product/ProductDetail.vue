<template>
  <div class="flex flex-col mb-24 lg:flex-row gap-5">
    <div class="w-full mb-7 lg:mb-0 lg:w-1/2">
      ...
      >
        <swiper-slide class="relative" v-for="item in productImg">
          <img
            class="w-full m-auto rounded-tr-2xl rounded-bl-2xl shadow-mYellow"
      ...
      <swiper
        ...
        class="w-5/6"
      >
        <swiper-slide v-for="item in productImg"
          ><img
            class="w-full m-auto rounded-tr-2xl rounded-bl-2xl shadow-mYellow"
            :src="imageUrl(item.img)"
        /></swiper-slide>
    ...
    <div class="w-full lg:w-1/2">
      <h3 class="text-3xl font-bold mb-1">[新品]肉鬆小脆餅</h3>
      <p class="text-xl text-Mred mb-5">單價:120元</p>
      ...
      >
        <span
          class="block relative after:content-[''] after:absolute after:block after:w-8 after:h-px after:bg-white after:top-1/2 after:right-0 before:absolute before:content-[''] before:block before:left-6 before:top-1/2 before:-translate-y-1/2 before:bg-talk before:w-4 before:h-4 before:bg-no-repeat before:bg-contain"
          >客服聊聊</span
        >
      </button>
      <div class="flex flex-wrap gap-5">
        ...
        >
          <span
            class="block relative after:content-[''] after:absolute after:block after:w-8 after:h-px after:bg-white after:top-1/2 after:right-0 before:absolute before:content-[''] before:block before:left-6 before:top-1/2 before:-translate-y-1/2 before:bg-cart before:w-4 before:h-4 before:bg-no-repeat before:bg-contain"
            >放入購物車</span
          >
        </button>
        <button
        ...
        >
          <span
            class="block relative after:content-[''] after:absolute after:block after:w-8 after:h-px after:bg-white after:top-1/2 after:right-0 before:absolute before:content-[''] before:block before:left-6 before:top-1/2 before:-translate-y-1/2 before:bg-bag before:w-4 before:h-4 before:bg-no-repeat before:bg-contain"
            >立即購買</span
          >
        </button>
      </div>
  ...
  <div class="w-full lg:w-1/2 mb-24">
    ...
    <div class="text-xl">
      ...
      <p>保存期限:4個月(未開封)</p>
      <p>原產地:台灣</p>
      <p>過敏原資訊:本產品含有大豆及麩質之穀類製品， 對特殊過敏體質者可能產生過敏症狀</p>
    </div>
  </div>

  <swiper
    class="recommend grid pt-32 pb-10 xs:pt-40 sm:pt-24"
    :slidesPerView="1"
    :spaceBetween="10"
    :navigation="true"
    :pagination="true"
  ...
  >
    ...
    <swiper-slide class="relative" v-for="item in product">
      <div class="h-full pb-1">
        ...
        >
          <RouterLink
            :to="`/product/productItem/${route.params.id}/productDetail`"
          ...
          >
            ...
            />
            <img
              class="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 hidden group-hover:block"
              src="../../assets/image/logo/logo-ck.png"
              alt=""
            />
          </RouterLink>
          <div class="p-4">
...
const product = [
  {
    img: 'product01.jpg',
    title: '[新品]肉鬆小脆餅肉鬆小脆餅肉鬆小脆餅肉鬆小脆餅',
    price: '150',
    tag: ['新品上市', '人氣推薦', '人氣推薦', '人氣推薦']
  },
  {
    img: 'product02.png',
    title: '[新品]肉鬆小脆餅肉鬆小脆餅肉鬆小脆餅',
    price: '150',
    tag: ['新品上市', '人氣推薦']
  },
  {
